...
# Output directory
outdir = "../results/plots_by_virus_uniquereads"
...
for virus in viruses:
    ...
    # Get groups
    group_control = virus_df[virus_df['disease'] == 'Control']['uniquely_mapped_reads']
    group_disease = virus_df[virus_df['disease'] == 'Juvenile Dermatomyositis']['uniquely_mapped_reads']
    ...
    # Save
    plt.savefig(f"{outdir}/viral_only_{virus}_control_vs_disease_uniquereads.png", dpi=300)
    plt.close()