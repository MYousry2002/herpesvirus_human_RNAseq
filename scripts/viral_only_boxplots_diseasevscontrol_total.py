...
# Output directory
outdir = "../results/plots_by_virus_totalreads"
...
for virus in viruses:
    ...
    # Get groups
    group_control = virus_df[virus_df['disease'] == 'Control']['total_mapped_reads']
    group_disease = virus_df[virus_df['disease'] == 'Juvenile Dermatomyositis']['total_mapped_reads']
    ...
    # Save
    plt.savefig(f"{outdir}/viral_only_{virus}_control_vs_disease_totalreads.png", dpi=300)
    plt.close()